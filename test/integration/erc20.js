    ...
    describe('integration', function () {
        it('sending transaction', function () {
            return __awaiter(this, void 0, void 0, function () {
                var allCoinHandlers, handler, integration1Keychain, integration2Keychain, balance1, balance2, fees, tx, txid;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            allCoinHandlers = AllCoinHandlers_1.createAllCoinHandlers(new _mocks_1.LogMock(), new _mocks_1.CacheWrapperMock());
                            handler = allCoinHandlers['ERC20.TST'];
