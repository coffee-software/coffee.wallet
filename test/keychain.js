...
describe('Keychain Test', function () {
    describe('mnemonics', function () {
        ...
        it('should generate specific hex seed', function () {
            assert_1.strictEqual(keychain1.getSeed().toString('hex'), "2fc8627a54d5c57de1b05a6763b9773aa2a333900282a64c3736ba195e7f1944c685817023f87fb72fa0b4b65859884de26557c571e453466ed5e4fdf3a2da47");
            assert_1.strictEqual(keychain2.getSeed().toString('hex'), "cf98815c8aed7fdc08bd31913772c08d9bfc787f3d133edea8ffdd20d29881a80d5ed12e44822d1888a1280ffd04648540e1470805cbfadb39663986d127ee96");
        });
        it('should generate unique, valid mnemonics', function () {
            var previous = keychain1.getSeed().toString('hex');
            for (var i = 0; i < 5; i++) {
                var randomKeychain = new Keychain_1.Keychain(Keychain_1.Keychain.newMnemonic());
                assert_1.notStrictEqual(previous, randomKeychain.getSeed().toString('hex'));
