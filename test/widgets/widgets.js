...
var AmountInputWidget_1 = require("../../src/Widgets/AmountInputWidget");
    ...
    describe('BigNum', function () {
        it('additions', function () {
            return __awaiter(this, void 0, void 0, function () {
                var provider, handler, w;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            provider = new CoinGeckoProvider_1.CoinGeckoProvider(new _mocks_1.CacheWrapperMock(), 'PLN');
                            handler = new HandlerBtc_1.HandlerBtc(new _mocks_1.LogMock(), new _mocks_1.CacheWrapperMock());
                            return [4, provider.updatePrices({ 'BTC': handler })];
                        case 1:
                            _a.sent();
                            w = new AmountInputWidget_1.AmountInputWidget(handler, provider);
