...
describe('Handlers Tests', function() {
    describe('All Coin Handlers', function () {
        ...
        it('should generate specific address for mnemonic', function () {
            ...
            strictEqual(
                new HandlerEth(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain1),
            ...
            strictEqual(
                new HandlerEth(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain2),
            ...
            strictEqual(
                new HandlerBtc(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain1),
            ...
            strictEqual(
                new HandlerBtc(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain2),
            ...
            strictEqual(
                new HandlerDoge(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain1),
            ...
            strictEqual(
                new HandlerDoge(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain2),
            ...
            strictEqual(
                new HandlerLtc(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain1),
            ...
            strictEqual(
                new HandlerLtc(new LogMock(), new CacheWrapperMock()).exportPrivateKey(keychain2),
