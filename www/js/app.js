...
var app = {
    ...
    popupAddNewAddress: function() {
      ...
      var randomPrivImg = this.generatePngWithQRCode(randomPriv);
      var randomAddrImg = this.generatePngWithQRCode(randomAddr);

      var html = '<html><h1>' + coinCode + ' wallet</h1>' +
        '<h2>public address</h2>' + randomAddr + '<br/><img src="' + randomAddrImg + '">'+
        '<h2>private key</h2>' + randomPriv + '<br/><img src="' + randomPrivImg + '">'+
        '<p>Generated by Coffee Wallet. Please keep this secured.</p>'+
        '</html>';
