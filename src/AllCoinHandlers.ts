...
export function createAllCoinHandlers(engine: Engine) : { [code: string] : BaseCoinHandler } {
    return {
        ...
        //PORTFOLIO
        'BCH': new PortfolioOnlyHandler('BCH', 'BCH', 'Bitcoin Cash', 'bch','bch-bitcoin-cash', 'bitcoin-cash', 'bitcoin-cash'),
        'BCH.TST': new PortfolioOnlyHandler('BCH.TST', 'BCH.TST', 'Bitcoin Cash TestNet', 'bch.test' ),

        '1INCH': new PortfolioOnlyHandler('1INCH', '1INCH', '1inch', '1inch', '1inch-1inch', '1inch', '1inch' ),
        'AAVE': new PortfolioOnlyHandler('AAVE', 'AAVE', 'Aave', 'aave', 'aave-new', 'aave', 'aave' ),
        'ADA': new PortfolioOnlyHandler('ADA', 'ADA', 'Cardano', 'ada', 'ada-cardano', 'cardano', 'cardano' ),
        'ALGO': new PortfolioOnlyHandler('ALGO', 'ALGO', 'Algorand', 'algo', 'algo-algorand', 'algorand', 'algorand' ),
        'AMP': new PortfolioOnlyHandler('AMP', 'AMP', 'Amp', 'amp', 'amp-amp', 'amp-token', 'amp' ),
        'ANKR': new PortfolioOnlyHandler('ANKR', 'ANKR', 'Ankr', 'ankr', 'ankr-ankr-network', 'ankr', 'ankr' ),
        'AR': new PortfolioOnlyHandler('AR', 'AR', 'Arweave', 'ar', 'ar-arweave', 'arweave', 'arweave' ),
        'ARRR': new PortfolioOnlyHandler('ARRR', 'ARRR', 'Pirate', 'arrr', 'arrr-pirate', 'pirate-chain', 'pirate-chain' ),
        'ATOM': new PortfolioOnlyHandler('ATOM', 'ATOM', 'Cosmos', 'atom', 'atom-cosmos', 'cosmos', 'cosmos' ),
        'AVAX': new PortfolioOnlyHandler('AVAX', 'AVAX', 'Avalanche', 'avax', 'avax-avalanche', 'avalanche-2', 'avalanche' ),
        'BAKE': new PortfolioOnlyHandler('BAKE', 'BAKE', 'BakeryToken', 'bake', '', 'bakerytoken', 'bakerytoken' ),
        'BCD': new PortfolioOnlyHandler('BCD', 'BCD', 'Bitcoin Diamond', 'bcd', 'bcd-bitcoin-diamond', 'bitcoin-diamond', 'bitcoin-diamond' ),
        'BEST': new PortfolioOnlyHandler('BEST', 'BEST', 'Bitpanda Ecosystem Token', 'best', 'best-bitpanda-ecosystem-token', 'bitpanda-ecosystem-token', 'bitpanda-ecosystem-token' ),
        'BSV': new PortfolioOnlyHandler('BSV', 'BSV', 'Bitcoin SV', 'bsv', 'bsv-bitcoin-sv', 'bitcoin-cash-sv', 'bitcoin-sv' ),
        'BTCB': new PortfolioOnlyHandler('BTCB', 'BTCB', 'Bitcoin BEP2', 'btcb', 'btcb-bitcoin-bep2', 'bitcoin-bep2', 'bitcoin-bep2' ),
        'BTG': new PortfolioOnlyHandler('BTG', 'BTG', 'Bitcoin Gold', 'btg', 'btg-bitcoin-gold', 'bitcoin-gold', 'bitcoin-gold' ),
        'BTT': new PortfolioOnlyHandler('BTT', 'BTT', 'BitTorrent', 'btt', 'btt-bittorrent', 'bittorrent-2', 'bittorrent' ),
        'BUSD': new PortfolioOnlyHandler('BUSD', 'BUSD', 'Binance USD', 'busd', 'busd-binance-usd', 'binance-usd', 'binance-usd' ),
        'CAKE': new PortfolioOnlyHandler('CAKE', 'CAKE', 'PancakeSwap', 'cake', 'cake-pancakeswap', 'pancakeswap-token', 'pancakeswap' ),
        'CDAI': new PortfolioOnlyHandler('CDAI', 'CDAI', 'cDAI', 'cdai', '', 'cdai', '' ),
        'CELO': new PortfolioOnlyHandler('CELO', 'CELO', 'Celo', 'celo', '', 'celo', 'celo' ),
        'CETH': new PortfolioOnlyHandler('CETH', 'CETH', 'cETH', 'ceth', '', 'compound-ether', '' ),
        'CHSB': new PortfolioOnlyHandler('CHSB', 'CHSB', 'SwissBorg', 'chsb', 'chsb-swissborg', 'swissborg', 'swissborg' ),
        'CHZ': new PortfolioOnlyHandler('CHZ', 'CHZ', 'Chiliz', 'chz', 'chz-chiliz', 'chiliz', 'chiliz' ),
        'COMP': new PortfolioOnlyHandler('COMP', 'COMP', 'Compound', 'comp', 'comp-compoundd', 'compound-governance-token', 'compound' ),
        'CSC': new PortfolioOnlyHandler('CSC', 'CSC', 'CasinoCoin', 'csc', 'csc-casinocoin', 'casinocoin', 'casinocoin' ),
        'CUSDC': new PortfolioOnlyHandler('CUSDC', 'CUSDC', 'cUSDC', 'cusdc', '', 'compound-usd-coin', '' ),
        'CVNT': new PortfolioOnlyHandler('CVNT', 'CVNT', 'Content Value Network', 'cvnt', 'cvnt-content-value-network', 'content-value-network', 'content-value-network' ),
        'DCR': new PortfolioOnlyHandler('DCR', 'DCR', 'Decred', 'dcr', 'dcr-decred', 'decred', 'decred' ),
        'DENT': new PortfolioOnlyHandler('DENT', 'DENT', 'Dent', 'dent', 'dent-dent', 'dent', 'dent' ),
        'DFI': new PortfolioOnlyHandler('DFI', 'DFI', 'DeFi Chain', 'dfi', 'dfi-defi-chain', 'defichain', 'defichain' ),
        'DGB': new PortfolioOnlyHandler('DGB', 'DGB', 'DigiByte', 'dgb', 'dgb-digibyte', 'digibyte', 'digibyte' ),
        'DOT': new PortfolioOnlyHandler('DOT', 'DOT', 'Polkadot', 'dot', 'dot-polkadot', 'polkadot', 'polkadot-new' ),
        'EGLD': new PortfolioOnlyHandler('EGLD', 'EGLD', 'Elrond', 'egld', 'egld-elrond', 'elrond-erd-2', 'elrond-egld' ),
        'ENJ': new PortfolioOnlyHandler('ENJ', 'ENJ', 'Enjin Coin', 'enj', 'enj-enjin-coin', 'enjincoin', 'enjin-coin' ),
        'EOS': new PortfolioOnlyHandler('EOS', 'EOS', 'EOS', 'eos', 'eos-eos', 'eos', 'eos' ),
        'ETC': new PortfolioOnlyHandler('ETC', 'ETC', 'Ethereum Classic', 'etc', 'etc-ethereum-classic', 'ethereum-classic', 'ethereum-classic' ),
        'FIL': new PortfolioOnlyHandler('FIL', 'FIL', 'Filecoin', 'fil', 'fil-filecoin', 'filecoin', 'filecoin' ),
        'FLOW': new PortfolioOnlyHandler('FLOW', 'FLOW', 'Flow', 'flow', 'flow-flow1141', 'flow', 'flow' ),
        'FTM': new PortfolioOnlyHandler('FTM', 'FTM', 'Fantom', 'ftm', 'ftm-fantom', 'fantom', 'fantom' ),
        'FTT': new PortfolioOnlyHandler('FTT', 'FTT', 'FTX Token', 'ftt', 'ftt-ftx-token', 'ftx-token', 'ftx-token' ),
        'GRT': new PortfolioOnlyHandler('GRT', 'GRT', 'The Graph', 'grt', 'grt-the-graph', 'the-graph', 'the-graph' ),
        'HBAR': new PortfolioOnlyHandler('HBAR', 'HBAR', 'Hedera Hashgraph', 'hbar', 'hbar-hedera-hashgraph', 'hedera-hashgraph', 'hedera-hashgraph' ),
        'HBTC': new PortfolioOnlyHandler('HBTC', 'HBTC', 'Huobi BTC', 'hbtc', '', 'huobi-btc', 'huobi-btc' ),
        'HEX': new PortfolioOnlyHandler('HEX', 'HEX', 'HEX', 'hex', 'hex-hex', 'hex', 'hex' ),
        'HNT': new PortfolioOnlyHandler('HNT', 'HNT', 'Helium', 'hnt', 'hnt-helium', 'helium', 'helium' ),
        'KCS': new PortfolioOnlyHandler('KCS', 'KCS', 'KuCoin Token', 'kcs', 'kcs-kucoin-token', 'kucoin-shares', 'kucoin-token' ),
        'KLAY': new PortfolioOnlyHandler('KLAY', 'KLAY', 'Klaytn', 'klay', '', 'klay-token', 'klaytn' ),
        'KSM': new PortfolioOnlyHandler('KSM', 'KSM', 'Kusama', 'ksm', 'ksm-kusama', 'kusama', 'kusama' ),
        'LEND': new PortfolioOnlyHandler('LEND', 'LEND', 'Aave', 'lend', 'lend-ethlend', 'aave', 'aave' ),
        'LSK': new PortfolioOnlyHandler('LSK', 'LSK', 'Lisk', 'lsk', 'lsk-lisk', 'lisk', 'lisk' ),
        'LUNA': new PortfolioOnlyHandler('LUNA', 'LUNA', 'LUNA', 'luna', 'luna-terra', 'terra-luna', 'terra-luna' ),
        'LUSD': new PortfolioOnlyHandler('LUSD', 'LUSD', 'Liquity USD', 'lusd', '', 'liquity-usd', 'liquity-usd' ),
        'MATIC': new PortfolioOnlyHandler('MATIC', 'MATIC', 'Matic Network', 'matic', 'matic-matic-network', 'matic-network', 'polygon' ),
        'MIOTA': new PortfolioOnlyHandler('MIOTA', 'MIOTA', 'IOTA', 'miota', 'miota-iota', 'iota', 'iota' ),
        'NANO': new PortfolioOnlyHandler('NANO', 'NANO', 'Nano', 'nano', 'nano-nano', 'nano', 'nano' ),
        'NEAR': new PortfolioOnlyHandler('NEAR', 'NEAR', 'Near Protocol', 'near', 'near-near-protocol', 'near', 'near-protocol' ),
        'NEO': new PortfolioOnlyHandler('NEO', 'NEO', 'NEO', 'neo', 'neo-neo', 'neo', 'neo' ),
        'OKB': new PortfolioOnlyHandler('OKB', 'OKB', 'OKB', 'okb', 'okb-okb', 'okb', 'okb' ),
        'ONE': new PortfolioOnlyHandler('ONE', 'ONE', 'Harmony', 'one', 'one-harmony', 'harmony', 'harmony' ),
        'ONT': new PortfolioOnlyHandler('ONT', 'ONT', 'Ontology', 'ont', 'ont-ontology', 'ontology', 'ontology' ),
        'QTUM': new PortfolioOnlyHandler('QTUM', 'QTUM', 'Qtum', 'qtum', 'qtum-qtum', 'qtum', 'qtum' ),
        'REN': new PortfolioOnlyHandler('REN', 'REN', 'Ren', 'ren', 'ren-republic-protocol', 'republic-protocol', 'ren' ),
        'REV2': new PortfolioOnlyHandler('REV2', 'REV', 'Revain', 'rev', 'rev-revain', 'revain', 'revain' ),
        'RSR': new PortfolioOnlyHandler('RSR', 'RSR', 'Reserve Rights', 'rsr', 'rsr-reserve-rights', 'reserve-rights-token', 'reserve-rights' ),
        'RUNE': new PortfolioOnlyHandler('RUNE', 'RUNE', 'THORChain', 'rune', 'rune-thorchain', 'thorchain', 'thorchain' ),
        'RVN': new PortfolioOnlyHandler('RVN', 'RVN', 'Ravencoin', 'rvn', 'rvn-ravencoin', 'ravencoin', 'ravencoin' ),
        'SC': new PortfolioOnlyHandler('SC', 'SC', 'Siacoin', 'sc', 'sc-siacoin', 'siacoin', 'siacoin' ),
        'SOL': new PortfolioOnlyHandler('SOL', 'SOL', 'Solana', 'sol', 'sol-solana', 'solana', 'solana' ),
        'STX': new PortfolioOnlyHandler('STX', 'STX', 'Blockstack', 'stx', 'stx-blockstack', 'blockstack', 'stacks' ),
        'SUSHI': new PortfolioOnlyHandler('SUSHI', 'SUSHI', 'Sushi', 'sushi', 'Sushi-sushi', 'sushi', 'sushiswap' ),
        'TEL': new PortfolioOnlyHandler('TEL', 'TEL', 'Telcoin', 'tel', 'tel-telcoin', 'telcoin', 'telcoin' ),
        'TFUEL': new PortfolioOnlyHandler('TFUEL', 'TFUEL', 'Theta Fuel', 'tfuel', 'tfuel-theta-fuel', 'theta-fuel', 'theta-fuel' ),
        'THR': new PortfolioOnlyHandler('THR', 'THR', 'ThoreCoin', 'thr', 'thr-thorecoin', 'thorecoin', 'thorecoin' ),
        'TRX': new PortfolioOnlyHandler('TRX', 'TRX', 'TRON', 'trx', 'trx-tron', 'tron', 'tron' ),
        'TTT': new PortfolioOnlyHandler('TTT', 'TTT', 'The Transfer Token', 'ttt', 'ttt-the-transfer-token', 'the-transfer-token', 'the-transfer-token' ),
        'UMA': new PortfolioOnlyHandler('UMA', 'UMA', 'UMA', 'uma', 'uma-uma', 'uma', 'uma' ),
        'UST': new PortfolioOnlyHandler('UST', 'UST', 'TerraUSD', 'ust', 'ust-terrausd', 'terrausd', 'terrausd' ),
        'VET': new PortfolioOnlyHandler('VET', 'VET', 'VeChain', 'vet', 'vet-vechain', 'vechain', 'vechain' ),
        'VGX': new PortfolioOnlyHandler('VGX', 'VGX', 'Voyager Token', 'vgx', 'ethos-ethos', 'ethos', 'voyager-token' ),
        'WAVES': new PortfolioOnlyHandler('WAVES', 'WAVES', 'Waves', 'waves', 'waves-waves', 'waves', 'waves' ),
        'XDCE': new PortfolioOnlyHandler('XDCE', 'XDCE', 'XinFin Network', 'xdce', 'xdce-xinfin-network', 'xdce-crowd-sale', '' ),
        'XEM': new PortfolioOnlyHandler('XEM', 'XEM', 'NEM', 'xem', 'xem-nem', 'nem', 'nem' ),
        'XLM': new PortfolioOnlyHandler('XLM', 'XLM', 'Stellar', 'xlm', 'xlm-stellar', 'stellar', 'stellar' ),
        'XMR': new PortfolioOnlyHandler('XMR', 'XMR', 'Monero', 'xmr', 'xmr-monero', 'monero', 'monero' ),
        'XRP': new PortfolioOnlyHandler('XRP', 'XRP', 'XRP', 'xrp', 'xrp-xrp', 'ripple', 'xrp' ),
        'XTZ': new PortfolioOnlyHandler('XTZ', 'XTZ', 'Tezos', 'xtz', 'xtz-tezos', 'tezos', 'tezos' ),
        'XVG': new PortfolioOnlyHandler('XVG', 'XVG', 'Verge', 'xvg', 'xvg-verge', 'verge', 'verge' ),
        'XVS': new PortfolioOnlyHandler('XVS', 'XVS', 'Venus', 'xvs', 'xvs-venus', 'venus', 'venus' ),
        'YFI': new PortfolioOnlyHandler('YFI', 'YFI', 'yearn.finance', 'yfi', 'yfi-yearnfinance', 'yearn-finance', 'yearn-finance' ),
        'ZEC': new PortfolioOnlyHandler('ZEC', 'ZEC', 'Zcash', 'zec', 'zec-zcash', 'zcash', 'zcash' ),
        'ZEN': new PortfolioOnlyHandler('ZEN', 'ZEN', 'Horizen', 'zen', 'zen-horizen', 'zencash', 'horizen' ),
    }
}
