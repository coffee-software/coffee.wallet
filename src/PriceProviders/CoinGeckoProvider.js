...
var CoinGeckoProvider = (function (_super) {
    __extends(CoinGeckoProvider, _super);
    function CoinGeckoProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "coingecko.com";
    ...
    CoinGeckoProvider.prototype.fetchPrices = function (handlers) {
        return __awaiter(this, void 0, void 0, function () {
            var names, path, response, key;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        names = Object.keys(handlers).map(function (key) { return handlers[key].name; });
                        path = encodeURI('/api/v3/simple/price?ids=' + names.join(',') + '&vs_currencies=' + this.unit);
                        return [4, Https_1.Https.makeJsonRequest('api.coingecko.com', path)];
                    case 1:
                        response = _a.sent();
                        for (key in handlers) {
...
//# sourceMappingURL=CoinGeckoProvider.js.map