...
var CoinPaprikaProvider = (function (_super) {
    __extends(CoinPaprikaProvider, _super);
    function CoinPaprikaProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.name = "coinpaprika.com";
    ...
    CoinPaprikaProvider.prototype.fetchPrices = function (handlers) {
        return __awaiter(this, void 0, void 0, function () {
            var path, list, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = encodeURI('/v1/tickers?quotes=' + this.unit);
                        return [4, Https_1.Https.makeJsonRequest('api.coinpaprika.com', path)];
                    case 1:
                        list = _a.sent();
                        for (i in list) {
...
//# sourceMappingURL=CoinPaprikaProvider.js.map